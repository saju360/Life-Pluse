...
public class FindBloodBankAddModel {
    ...
    public FindBloodBankAddModel() {
    }

    public FindBloodBankAddModel(String uid, String orgname_Ed, String orgaddress_Ed, String orgphone_Ed, String orgemail_Ed, String orgfb_Ed, String orginsta_Ed, String orgyout_Ed, String orgweb_Ed, Timestamp addedtime) {
        this.uid = uid;
