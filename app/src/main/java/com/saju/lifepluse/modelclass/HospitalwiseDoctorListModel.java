...
public class HospitalwiseDoctorListModel implements Parcelable {
    ...
    protected HospitalwiseDoctorListModel(Parcel in) {
        catId = in.readString();
    ...
    public static final Creator<HospitalwiseDoctorListModel> CREATOR = new Creator<HospitalwiseDoctorListModel>() {
        @Override
        public HospitalwiseDoctorListModel createFromParcel(Parcel in) {
            return new HospitalwiseDoctorListModel(in);
        }

        @Override
        public HospitalwiseDoctorListModel[] newArray(int size) {
            return new HospitalwiseDoctorListModel[size];
        }
    };
