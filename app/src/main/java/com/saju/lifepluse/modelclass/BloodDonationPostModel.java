...
public class BloodDonationPostModel {

    String bloodNeed, bloodgroup, date, bloodQty, hospital, division, manualDivision, reference, contact, currentTime, documentId;

    public BloodDonationPostModel() {
    }

    public BloodDonationPostModel(String bloodNeed, String bloodgroup, String date, String bloodQty, String hospital, String division, String manualDivision, String reference, String contact, String currentTime, String documentId) {
