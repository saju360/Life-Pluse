...
public class Find_Blood_Bank_Edit_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_blood_bank_edit_profile);
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Find_Blood_Bank_Edit_Profile.this, Find_Blood_Bank_Home.class));
                finish();
    ...
    private void deleteorg() {
        ...
        new AlertDialog.Builder(Find_Blood_Bank_Edit_Profile.this)
                .setTitle("Blood Bank Deletation")
                .setIcon(R.drawable.alert_icon)
                .setMessage("Are you sure you want to delete your Blood Bank?")
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        FirebaseUtil.donerUserDetails("FindBloodBank").delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {

                                finish();

                                FirebaseUtil.currentUserDetails().update("isfindbbankadd", false);
                                FirebaseUtil.currentUserDetails().update("isfindbbanknotadd", true);

                                Toast.makeText(getApplicationContext(), "Blood Bank Delete Successfully", Toast.LENGTH_SHORT).show();
    ...
    private void DataRetrive() {
        ...
        FirebaseUtil.donerUserDetails("FindBloodBank").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    FindBloodBankAddModel model = task.getResult().toObject(FindBloodBankAddModel.class);
                    ...
                    org_edit_icon.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent intent = new Intent(getApplicationContext(), Find_Blood_Bank_Post.class);
