...
public class Find_Blood_Bank_Post extends AppCompatActivity {
    ...
    FindBloodBankAddModel findBloodBankAddModel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_find_blood_bank_post);
        statusbarcolor();
        initial();
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Find_Blood_Bank_Post.this, Find_Blood_Bank_Home.class));
                finish();
            }
        });
    ...
    private void retrivepersingData() {
        ...
        if (!org_name.isEmpty() && org_name != null) {
            ...
            org_title.setText("Update Your Blood Bank Info");
    ...
    private void orgDataAdd(String orgname, String orgaddress, String orgphone, String orgemail, String orgfblink, String orginstalink, String orgyoutlink, String orgweblink) {
        ...
        findBloodBankAddModel = new FindBloodBankAddModel(uid, orgname, orgaddress, orgphone, orgemail, orgfblink, orginstalink, orgyoutlink, orgweblink, Timestamp.now());
        ...
        if (isEditMode) {
            ...
            FirebaseUtil.donerUserDetails("FindBloodBank").update(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void unused) {
                    setInProgress(false);

                    Log.d("datasave", "data update successfully");
                    startActivity(new Intent(Find_Blood_Bank_Post.this, Find_Blood_Bank_Edit_Profile.class));
                    finish();
            ...
            FirebaseUtil.donerUserDetails("FindBloodBank").set(findBloodBankAddModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void unused) {

                    setInProgress(false);

                    FirebaseUtil.currentUserDetails().update("isfindbbankadd", true);
                    FirebaseUtil.currentUserDetails().update("isfindbbanknotadd", false);
